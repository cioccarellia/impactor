...
class Core {
    ...
    * */
    ...
    object unroot {
        ...
        val remove_magisk = arrayOf("rm -rf /data/*magisk*", "rm -rf /data/magisk.img", "rm -rf /magisk/.core/su/su", "rm -rf /magisk/.core/su/sbin_bind/su", "rm -rf /magisk/.core/post-fs-data.d", "rm -rf /magisk/.core/su", "rm -rf /data/data/*com.topjohnwu.magisk*", "rm -rf /data/app/*com.topjohnwu.magisk*", "rm -rf /system/app/*com.topjohnwu.magisk*", "rm -rf /system/app/*magisk*", "rm -rf /cache/magisk.log /cache/last_magisk.log /cache/magiskhide.log /cache/.disable_magisk", "rm -rf /cache/magisk", "rm -rf /cache/magisk_merge /cache/magisk_mount", "rm -rf /cache/unblock /cache/magisk_uninstaller.sh", "rm -rf /data/magisk", "rm -rf /data/magisk.img", "rm -rf /data/magisk_merge.img", "rm -rf /data/busybox", "rm -rf /data/magisk", "rm -rf /data/custom_ramdisk_patch.sh 2>/dev/null")
